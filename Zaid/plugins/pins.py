...
PINS_TEXT = """
** يمكن العثور على جميع الأوامر المتعلقة بالدبوس هنا ؛ حافظ على تحديث الدردشة الخاصة بك على آخر الأخبار برسالة مثبتة بسيطة! ** ‣ `؟ pin` - لتثبيت رسالة رد. ‣ `؟ unpin` - لإلغاء تثبيت أحدث رسالة مثبتة. ‣ `؟ unpinall` - لإلغاء تثبيت جميع الرسائل المثبتة مرة واحدة. ‣ `؟ pinned` - للحصول على الرسالة المثبتة الحالية ** ➥ ملاحظة: ** __إضافة "إعلام" بعد؟ دبوس لإعلام جميع أعضاء الدردشة .__
"""
