...
PR_HELP = """
** ✘ هل تريد حذف الكثير من الرسائل؟ هذا هو سبب التطهير! ** ‣ `؟ purge` - قم بالرد على رسالة لحذف الرسائل من هناك. ‣ `؟ spurge` - مثل التطهير ، لكن لا يرسل رسالة التأكيد النهائية. ‣ `؟ del` - يحذف الرد على الرسالة.
"""
